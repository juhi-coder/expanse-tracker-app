...
async function updateUserProfile(details) {
  const firebaseApiUrl = `https://identitytoolkit.googleapis.com/v1/accounts:update?key=AIzaSyAvqTEz76Hno8-JWHFse2J9rBPIO4q1hfs`;
...
async function getUserProfile(idToken) {
  const firebaseApiUrl = `https://identitytoolkit.googleapis.com/v1/accounts:lookup?key=AIzaSyAvqTEz76Hno8-JWHFse2J9rBPIO4q1hfs`;
...
async function verifyEmail(idToken) {
  const firebaseApiUrl = `https://identitytoolkit.googleapis.com/v1/accounts:sendOobCode?key=AIzaSyAvqTEz76Hno8-JWHFse2J9rBPIO4q1hfs`;
