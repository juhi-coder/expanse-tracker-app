...
async function loginAndSignUp(signupData, isLogIn) {
  let url =
    "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyAvqTEz76Hno8-JWHFse2J9rBPIO4q1hfs";
  if (isLogIn) {
    url =
      "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyAvqTEz76Hno8-JWHFse2J9rBPIO4q1hfs";
  }
  try {
